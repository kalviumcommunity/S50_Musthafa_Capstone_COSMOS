    ...
    <>
      <div className="p-10">
        <h2 className="text-5xl font-bold w-full mb-4">
          SpaceX launches 22 Starlink satellites from California in dusky
          evening liftoff
        </h2>
        <div className="flex gap-10 mt-10">
          <img
            src="https://cdn.mos.cms.futurecdn.net/WgwHfgLumAtmUDDt98cU3J-650-80.jpg"
            alt=""
            className="w-2/4"
          />
          <div className="text-2xl font-normal">
            <p className="">
              ...
              quibusdam quam ea exercitationem molestias cupiditate voluptatum
              explicabo! Velit quibusdam mollitia beatae quam dignissimos nam,
              quae natus cum, aliquid accusantium aliquam?
              lore
            </p>
          </div>
        </div>
